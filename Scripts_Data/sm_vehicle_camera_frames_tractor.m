...
camera_param.veh_to_cam = [   -1.5      0.0145        0.7+0.2];
...
camera_param.xyz_r      = [  -5-5      0        1.1];   % Rear
camera_param.xyz_d      = [   3.84+0.5   3.2+0.5      1.1+1.5].*[2 2 1]/1.5;   % Front Left (diagonal)
...
camera_param.seat_fl    = [  -0.50    0.38*0  1.35];  % Seat Front Left       (right) 
